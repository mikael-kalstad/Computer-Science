...
class Client2 {
  ...
  private TaskOverview2 oversikt;
  public Client2(TaskOverview2 oversikt) {
  ...
  public String lesValg() {
    int antStud = oversikt.getNumOfStud();
  ...
  private void registrerNyStudent() {
    ...
    if (oversikt.registerNewStudent(navnNyStud)) {
    ...
    private void registrerOppgaver(String studNavn) {
      ...
      do { // gjentar inntil registrering aksepteres av objektet oversikt
        try {
          ...
          oversikt.increaseNumOfTasks(studNavn, antOppgOkning);  // kan ikke returnere false, pga navn alltid gyldig
      ...
      melding = "Totalt antall oppgaver registrert på " + studNavn + " er " + oversikt.numOfTasks(studNavn) + ".";
  ...
  class Oppgave1 {
    ...
    TaskOverview2 oversikt = new TaskOverview2();
    Client2 bgs = new Client2(oversikt);
